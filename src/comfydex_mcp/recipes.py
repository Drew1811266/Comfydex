...
_RECIPES: tuple[WorkflowRecipe, ...] = (
    ...
    WorkflowRecipe(
        recipe_id="character-consistency-lora",
        name="Character Consistency",
        description="Generate a consistent character image or sheet with a compatible character LoRA.",
        template_id="lora-text-to-image",
        intent_phrases=[
        ...
        tags=["character", "consistency", "character-sheet", "lora", "text-to-image"],
        required_nodes=[
            "CheckpointLoaderSimple",
            "LoraLoader",
            "CLIPTextEncode",
        ...
        safety_notes=["Requires a checkpoint and a compatible character LoRA."],
        examples=["consistent character sheet using my character lora"],
    ),
    WorkflowRecipe(
        recipe_id="product-image-basic",
        name="Product Image",
        description="Generate a clean product image for catalog, marketplace, or ecommerce use.",
        template_id="basic-text-to-image",
        intent_phrases=[
            "product image",
            "product photo",
        ...
        tags=["product", "ecommerce", "catalog", "white-background", "text-to-image"],
        required_nodes=[
            "CheckpointLoaderSimple",
            "CLIPTextEncode",
            "EmptyLatentImage",
        ...
        optional_inputs=["negative_prompt", "width", "height", "steps", "cfg", "seed"],
        safety_notes=["Requires a compatible checkpoint model."],
        examples=["product image on white background"],
    ),
    WorkflowRecipe(
    ...
    WorkflowRecipe(
        recipe_id="inpainting-basic",
        name="Inpainting",
        description="Edit a masked region in an existing image with a prompt and checkpoint.",
        template_id="inpaint-basic",
        intent_phrases=["inpaint", "inpainting", "inpaint masked area", "masked edit"],
        tags=["inpaint", "inpainting", "mask", "masked", "edit"],
        required_nodes=[
            "LoadImage",
            "LoadImageMask",
            "CheckpointLoaderSimple",
        ...
        safety_notes=["Requires a source image, a mask image, and a compatible checkpoint."],
        examples=["inpaint masked area to remove an object"],
    ),
    WorkflowRecipe(
        recipe_id="background-replacement-inpaint",
        name="Background Replacement",
        description="Replace or regenerate the background of an image using an inpaint mask.",
        template_id="inpaint-basic",
        intent_phrases=[
        ...
        tags=["background", "replacement", "inpaint", "mask", "edit"],
        required_nodes=[
            "LoadImage",
            "LoadImageMask",
            "CheckpointLoaderSimple",
        ...
        safety_notes=["Requires a mask that selects the background region."],
        examples=["replace image background with a clean studio background"],
    ),
    WorkflowRecipe(
